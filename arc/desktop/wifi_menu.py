...
import threading
import time
from arc.core import config, ScrollableList, MessageBox, SearchBox
...
LOCK_ICON_PATH = _os.path.join(_project_root, "arc", "assets", "icons", "wifi_locked_black.png")
OPEN_ICON_PATH = _os.path.join(_project_root, "arc", "assets", "icons", "wifi_unlocked_black.png")
